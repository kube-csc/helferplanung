    ...
    public function run()
    {
        ...
        \DB::table('operational_locations')->insert(
            array(
                ...
                array('id' => '8', 'einsatzort' => 'Stegdienst', 'beschreibung' => NULL, 'autor_id' => '1', 'bearbeiter_id' => '1', 'freigeber_id' => NULL, 'letzteFreigabe' => NULL, 'deleted_at' => NULL, 'created_at' => '2023-02-18 15:58:47', 'updated_at' => '2023-02-18 16:14:34')
            )
        );
    }
}
